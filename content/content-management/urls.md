...
By default, all URLs generated by Hugo will be suffixed with a `/`. If you would like to turn this feature off, set `trimTrailingSlash = true` or `trimTrailingSlash: true` in your site's `config.toml` or `config.yaml` file, respectively.
